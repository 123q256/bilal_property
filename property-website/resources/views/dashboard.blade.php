        ...
        <div class="card o-hidden profile-greeting">
          <div class="card-body">
            ...
            <div class="greeting-user text-center">
              <div class="profile-vector"><img class="img-fluid" src="{{ asset('admin/assets/images/dashboard/welcome.png')}}" alt=""></div>
            ...
            <div class="row m-0 chart-main">
                ...
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="right-chart-content">
                      <h4>{{ $totallistingproperty }}</h4><span>Total Listing </span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="right-chart-content">
                      <h4>{{ $totalDeveloper }}</h4><span>Total Developers</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="right-chart-content">
                      <h4>{{ $totaluser }}</h4><span>Total Users</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                <div class="media border-none align-items-center">
                  ...
                  <div class="media-body">
                    <div class="right-chart-content">
                      <h4>{{ $totaluserForm }}</h4><span>Total Users(By Form)</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0">
                <div class="appointment-table table-responsive">
                  <table class="table table-bordernone">
                    <tbody>
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle mb-3" src="{{ asset('admin/assets/images/appointment/app-ent.jpg')}}" alt="Image description">
                      ...
                      <tr>
                        <td><img class="img-fluid img-40 rounded-circle" src="{{ asset('admin/assets/images/appointment/app-ent.jpg')}}" alt="Image description">
                          <div class="status-circle bg-primary"></div>
                        </td>
            ...
            <div class="media">
              <div class="media-body">
                <div class="d-flex mb-3">
                  <div class="inner-img"><img class="img-fluid" src="{{ asset('admin/assets/images/notification/1.jpg')}}" alt="Product-1"></div>
                  <div class="inner-img"><img class="img-fluid" src="{{ asset('admin/assets/images/notification/2.jpg')}}" alt="Product-2"></div>
            ...
            <div class="chat">
              <div class="media left-side-chat">
                <div class="media-body d-flex">
                  <div class="img-profile"> <img class="img-fluid" src="{{ asset('admin/assets/images/user.jpg')}}" alt="Profile"></div>
                  <div class="main-chat">
