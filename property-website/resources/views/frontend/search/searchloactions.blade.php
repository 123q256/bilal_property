...
<div class="container pb-5 pt-3">
  ...
  // dd($Listing);
             ...
             <div class="col-md-4">
                ...
                <div class="card">
                   <a href="{{ url('/propert_details'.'/'.$Listing->id) }}"> <img src="{{ asset('/admin_images/Listing_property_images/'.$ListingImages->list_pro_image) }}" style="width: 100%" alt="Palm Springs Road"/></a>
                  <div class="card-body">
