...
<!-- Property Type Start  -->
 ...
 <div class="container property_main_to_container" style="width: 95%!important;">
    <div class="row">
          <div class="col-md-9">
              <h6 class="project_heading_6">{{ $locatisearch->location }}</h6>
          </div>
          <div class="col-md-3 d-flex flex-row-reverse mt-3" >
          
             <h5>Home » {{ $locatisearch->location }}</h5>
...
<div class="container pb-5 pt-3">
  ...
  // dd($Listing);
             ...
             <div class="col-md-4">
                <?php $ListingImages = App\Models\ListingPropertyImage::where('list_property_id', $Listing->id)->first();?> 
                <div class="card">
                   <a href="{{ url('/propert_types/propert_details'.'/'.$Listing->id) }}"> <img src="{{ asset('/admin_images/Listing_property_images/'.$ListingImages->list_pro_image) }}" style="width: 100%" alt="Palm Springs Road"/></a>
                  <div class="card-body">
