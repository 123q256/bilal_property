...
@section('title','All Chat Bot Users')
        ...
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Chat Bot Users</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <table class="display" id="basic-1">
                  <thead>
                    <tr>
                      ...
                      <th>Email</th>
                      <th>Phone No</th>
                      <th>What is your preferred currency?</th>
                      <th>Investment range:</th>
                      <th>property type</th>
                      <th>Number of bedrooms</th>
                      <th>You looking to buy a property?</th>
                      <th>Are you currently in Dubai?</th>
                  ...
                  <tbody>
                    ...
                    @forelse ($Chatboxs as $Chatbox)

                    <tr class="tr-shadow select_{{$Chatbox->id}}">
                        <td><input type="checkbox"  name="check[]" class="sub_chk" data-id="{{$Chatbox->id}}" id="master"></td>
                        <td>{{ $Chatbox->id }}</td>
                        <td>{{ $Chatbox->chatbox_category }}</td>
                        <td>{{ $Chatbox->chatbox_your_name }}</td>
                        <td>{{ $Chatbox->chatbox_company_name }}</td>
                        <td>{{ $Chatbox->chatbox_email }}</td>
                        <td>{{ $Chatbox->chatbox_phone_no }}</td>
                        <td>{{ $Chatbox->chatbox_budget }}</td>
                        <td>{{ $Chatbox->chatbox_investment }}</td>
                        <td>{{ $Chatbox->chatbox_aed }}</td>
                        <td>{{ $Chatbox->chatbox_apartment }}</td>
                        <td>{{ $Chatbox->chatbox_studio }}</td>
                        <td>{{ $Chatbox->chatbox_immediately }}</td>
                        <td>{{ $Chatbox->chatbox_specific_requirement }}</td>
                        <td>
                            @if(!empty($Chatbox->chatbox_details))
                            {{ $Chatbox->chatbox_details }}
                            @else
                            NO Details Found
                            @endif
                        </td>
                        ...
                        <td>
                            <div class="table-data-feature">
                                <a href="{{ url('admin/chatusers/'.$Chatbox->id.'/edit') }}" style="right:45%" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                 <i class="zmdi zmdi-edit"  style="font-size: 25px;"></i>
                                </a>
                                <a  data-id="{{ $Chatbox->id }}"  style="right:45%;cursor: pointer;" class="item developer_item_one userschat_item_one" data-toggle="tooltip" data-placement="top" title="Delete">
