        ...
        <div class="row">
          ...
          <div class="col-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Bed Rooms list</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <div class="table-data__tool  checkbox_hidden_btn" style="display: none"> 
                         <button type="button"  class="btn btn-info" id="all_delete_bedrooms"> Delete</button>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3" style="text-align: end;">
                     <a href="{{url('admin/bedrooms/create')}}"  class="btn btn-primary">Add Room</a>
                    </div>
                </div>
              ...
              <div class="table-responsive product-table">
                <table class="display" id="basic-1">
                  ...
                  <tbody>
                    ...
                    <tr class="tr-shadow select_{{$Bedroom->id}}">
                        <td><input type="checkbox"  name="check[]" class="sub_chk" data-id="{{$Bedroom->id}}" id="master"></td>
                        <td>{{$num++}}</td>
                        ...
                        <td class="desc"> 
                              ...
                              <label class="switch">
                                <input type="checkbox" onchange="update_type('{{ $Bedroom->id }}')"  class="check_get_id" @if ($Bedroom->status == 1) checked  @else '' @endif    name="checkbox_get_value">
                                <span class="slider round"></span>
                            </label>
                           
                         
                        </td>
                        <td class="desc">{{ $Bedroom->created_at->format('d-m-Y') ?? 'Not found'  }}</td>
                        <td>
                            
                                <a style="padding: 6px 15px;font-size: 14px;" href="{{ url('admin/bedrooms/'.$Bedroom->id.'/edit') }}" class="btn btn-success btn-xs" data-original-title="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Edit">
                                    Edit
                                </a>
                             
                          

                            <button  data-id="{{ $Bedroom->id }}"  class="btn btn-danger btn-xs bedrooms_item_one" type="button" data-original-title="btn btn-danger btn-xs" title="">Delete</button>
...
<script>
 ...
 function update_type(types_id){
    ...
    $.ajax({
                type: 'get',
                data: property,
                url: "{{ route('switch_bedrooms_checkbox') }}",
...
{{-- Checkbox  select multiples item  deleted --}}
  ...
  <script>
         ...
         $(document).on('click', '#all_delete_bedrooms', function(e) {
                        e.preventDefault();
                        var allVals = [];
