...
<div class="container-fluid">
  <div class="page-title">
    <div class="row">
        <div class="col-6">
          <h3>
            Add Bed Room Number</h3>
        </div>
          <div class="col-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
              <li class="breadcrumb-item">Apps</li>
              <li class="breadcrumb-item active">Bed Room Create</li>
            </ol>
          </div>
    </div>
  </div>
    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{url('admin/bedrooms/create')}}" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="form theme-form">
            ...
            <div class="row">
              <div class="col">
                <div class="text-end">
                  <button type="submit" class="btn btn-success me-3">Add Bed Room</button>
