    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{url('admin/addcurrencys/create')}}" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="form theme-form">
            ...
            <div class="row">
              <div class="col">
                <div class="text-end">
                  <button type="submit" class="btn btn-success me-3">Add Currency</button>
                
                  <a class="btn btn-danger" href="{{url('admin/addcurrencys')}}">Cancel</a>
                </div>
              </div>
            </div>
          </div>
