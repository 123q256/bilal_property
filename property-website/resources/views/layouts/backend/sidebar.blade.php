        ...
        <div class="sidebar-wrapper">
            <div>
              <div class="logo-wrapper"><a href="{{ url('admin/dashboard') }}">
                <img class="img-fluid for-light" src="{{ asset('admin/logo-image/image_2.png')}}" style="max-width: 86%;" alt="">
                <img class="img-fluid for-dark" src="{{ asset('admin/logo-image/image_2.png')}}" style="max-width: 86%;" alt=""></a>
                <div class="back-btn"><i class="fa fa-angle-left"></i></div>
                <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
              </div>
              <div class="logo-icon-wrapper"><a href="">
                <img class="img-fluid" src="{{ asset('admin/assets/images/logo/logo-icon.png')}}" alt=""></a></div>
              <nav class="sidebar-main">
                <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
                <div id="sidebar-menu">
                  <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="">
                      <img class="img-fluid" src="{{ asset('admin/assets/images/logo/logo-icon.png')}}" alt=""></a>
                    ...
                    <li class="sidebar-list">
                      <label class="badge badge-danger">New</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="box"></i><span>Update  Details                </span></a>
                      <ul class="sidebar-submenu">
                        <li><a href="{{ url('admin/developer') }}">Developer</a></li>
                        <li><a href="{{ url('admin/type_property') }}">Type Property</a></li>
                        <li><a href="{{ url('admin/bedrooms') }}">Bed Room</a></li>
                        <li><a href="{{ url('admin/payment_planes') }}">Payment Planes</a></li>
                        <li><a href="{{ url('admin/locations') }}">Locations</a></li>
                        <li><a href="{{ url('admin/listing_property') }}">Listing Property</a></li>
                        <li><a href="{{ url('admin/addcurrencys') }}">Currency</a></li>
                        <li><a href="{{ url('admin/addbudget') }}">Add Budget</a></li>
                        <li><a href="{{ url('admin/completions/create') }}">Add Completion Date</a></li>
                       

                      </ul>
                    </li>

                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ url('admin/developer/create') }}">
                      <i data-feather="git-pull-request"> </i><span>Add Developer</span></a></li>
                    <li class="sidebar-list"> 
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ url('admin/listing_property/create') }}">
                      <i data-feather="git-pull-request"> </i><span>Add Listing Property</span></a></li>
                    <li class="sidebar-list"> 
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="users"></i><span>Users</span></a>
                      <ul class="sidebar-submenu">
                        ...
                        <li><a href="{{ url('admin/chatusers') }}">Chat Bot Users</a></li>
                        <li><a href="{{ url('admin/interestusers') }}">Interested Property Users</a></li>
