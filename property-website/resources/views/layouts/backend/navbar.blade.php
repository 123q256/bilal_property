    ...
    <div class="header-wrapper row m-0">
      ...
      <div class="left-header col horizontal-wrapper ps-0">
        {{-- <ul class="horizontal-menu"> --}}
          {{-- <li class="mega-menu outside"><a class="nav-link" href="#!">
            <i data-feather="layers"></i><span>Bonus Ui</span></a>
      ...
      <div class="nav-right col-8 pull-right right-header p-0">
        <ul class="nav-menus">
          ...
          <li class="profile-nav onhover-dropdown p-0 me-0">
            <div class="media profile-media"><img class="b-r-10" src="{{ asset('admin/assets/images/dashboard/profile.jpg')}}" alt="">
              <div class="media-body"><span> {{ Auth::user()->first_name }}</span>
                <p class="mb-0 font-roboto">{{ Auth::user()->last_name }} <i class="middle fa fa-angle-down"></i></p>
              </div>
            </div>
            ...
            <li><a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              <i data-feather="log-in"> </i><span>Logout</span>  </a>
